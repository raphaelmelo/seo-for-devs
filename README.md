...
Esse é um guia para devs de qualquer nível, os conceitos e a pratica se cruzaram, vou exemplificar cada tema mas ainda assim se surgir alguma dúvida, você pode me chamar no linkedin ou deixar um comentário aqui em baixo. 

> **Nesse repositório vai ler sobre tecnicas de SEO on-page para devs**
- Ferramentas gratuitas do Google para SEO
 - Otimização de sites para os mecanismos de pesquisa como Google
- Entenda o que são palavras-chave
...
### Adicione e verifique seu site com o Google Search Console
...
+ **Google Analytics** é a melhor ferramenta para monitorar  (também é gratuita). Siga <a href="https://rockcontent.com/br/blog/como-instalar-google-analytics/"> esse tutorial</a> e saiba como inserir código de trackeamento no seu site,
...
## Liçao de Casa para Devs en SEO
### URLs & Links
##### Em SEO precisamos verificar de que TODAS as páginas do seu site possuem URLs amigáveis, devemos prezar pelas seguintes características:
...
> **Ex:** raphaelmelo.dev/portfolio ou raphaelmelo.dev/seo-para-devs

##### Se você ainda não migrou seu site para https, este é um item de alta prioridade em sua lista de tarefas.
+ Sites HTTPS é uma implementação do protocolo HTTP sobre uma camada adicional de segurança que utiliza o protocolo SSL/TLS. Essa camada adicional permite que os dados sejam transmitidos por meio de uma conexão criptografada.
---
### Estrutura 

##### Otimizar a estrutura do seu site 
...
+ Uma última coisa a revisar antes de prosseguir para o resto dos itens nesta lista de verificação de SEO é otimizar o logotipo e o favicon do seu site. 
	 +  Certificando-se de que seu logotipo é uma imagem e não um texto - o Google pode decidir mostrar seu logotipo nos resultados da pesquisa e, para fazer isso, ele deve ser uma imagem.
...
O SEO On-Page tem tudo a ver com o conteúdo da sua página e tem **um pilar principal:**

+ **Ser semantico**
 
Siga esse checklist de verificações em cada uma das suas páginas

<img src="https://lh3.googleusercontent.com/Q9Bq37axAFSEskEZtRtU3wYxu6-RXz4aZE5xz0axjuq0dyHIZWbJfM3EIcLdUgQ1OyNXAYe0396aQVpbGqI8h0CkqhTbM_G2qnN8Ul298mp-U_tQ2_zG1ffsm6sjkiAKPFCbrmoMFJxKBCj9cGayk4R8NDBaYUO9f4tTqreEtXI1ZTkqy1QDI2dCVI1tH0Dm-lu3k7aWa6kRSl64vvuMD1U20p3eYSouKAc2DZkJaYzlLCOGyzdXHs9_dr0Wx_mXzyQ29PMqI7XSFl-YeDmqyA01VtxMRmxzBZf5VmSAk9DDpbO_mTGW5mfkvriGI7FSkPR9oXNikVEEfjpwLwaXMM-Abs-rtjpwFrYvMeCgoslAfHCkxIinuXCCwK0hoIWmsIT77L-I0lSilS2xYYERVP9YYTgqgvxEG_ZFIavthShTaH8_KeNjK0YWG7n1HYaobe4C0h0r2kq4S-BbBuPMbir_o9U9JEpHBCljUIpv4xX57jCVZkCnA5WM6rYMnjD934tKKpaklVNTczY6B8fhB_Bpirkb28mek31Z_7wLHk3Txy9wfJYHkFp72FOYxNMuvielJBJtUPEjGpIxqbs2FoyFscSjT8hWD7H7zajEfrCFeuPA60GqsAeHeEqlA4a5GZVwun1S0xEt1xvgSIpUh4YhKnNq5fvpFBRN7wmf4-Eg1bZzMWEbVXvB1aW8=w595-h137-no?authuser=0" alt="Titulo e descrição de site na pesquisa do google" width="100%"/>

##### - Otimize os títulos de sua página (incluindo a página inicial)
...
+ Otimize o texto alternativo da imagem
	+ Escreva normalmente e tente descrever em poucas palavras do que se trata a imagem. Use palavras-chave que sejam relevantes para o conteúdo da página, mas não exagere. Mantenha seu texto alternativo curto e direto ao ponto.



## Support

Qualquer dúvida sobre o conteúdo acima fale comigo:

-   Linkedin  [`in/raphaelmelo`](https://www.linkedin.com/in/raphaelgois)
